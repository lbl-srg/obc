within Buildings.Examples.MultiZoneOfficeSimpleAir.TestCases;
model TestCase
  ...
  extends Buildings.Examples.MultiZoneOfficeSimpleAir.BaseClasses.HVACBuilding(
...
<li>
<code>hvac_reaAhu_T
Sup_y</code> [K] [min=None, max=None]: Cooling coil supply water temperature measurement for AHU
</li>
<li>
