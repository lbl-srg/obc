within Buildings.Examples.MultiZoneOfficeSimpleAir.BaseClasses;
partial model HVACBuilding
  ...
  replaceable
  Buildings.Examples.MultiZoneOfficeSimpleAir.BaseClasses.PartialHVAC hvac
    constrainedby
    Buildings.Examples.MultiZoneOfficeSimpleAir.BaseClasses.PartialHVAC(
