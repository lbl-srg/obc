...
def verification_plot(error_folder, output_folder, plot_filename, y_label='Value'):
    ...
    data_ref = pd.read_csv(error_folder+'/reference.csv', index_col=0)
    data_test = pd.read_csv(error_folder+'/test.csv', index_col=0)
    data_err = pd.read_csv(error_folder+'/errors.csv', index_col=0)
    data_low = pd.read_csv(error_folder+'/lowerBound.csv', index_col=0)
    data_upp = pd.read_csv(error_folder+'/upperBound.csv', index_col=0)
    ...
    fig.write_image(output_folder+plot_filename)
