...
model OneDeviceWithWSE_HeaPreValAndWSEOnOffAndStaging
  ...
  Buildings.Fluid.Sources.Boundary_pT expVesCHW1(redeclare package Medium =
    ...
    annotation (Placement(transformation(extent={{220,281},{240,301}})));
equation
  PSupFan = fan.P;
  PChiWatPum = pumCHW.P;
  PConWatPum = pumCW.P;
  ...
  connect(TConWatRetSen.port_a, val5.port_a) annotation (Line(points={{164,140},
          {164,170},{160,170}},           color={0,127,255},
      thickness=0.5));
  ...
  connect(expVesCHW1.ports[1], cooTow.port_b) annotation (Line(
      points={{240,291},{240,239},{221,239}},
      color={0,127,255},
      thickness=0.5));
  annotation (
...
end OneDeviceWithWSE_HeaPreValAndWSEOnOffAndStaging;
