...
equation
  connect(TChiWatSup, chiSwi.chiCHWST) annotation (Line(points={{-120,70},{-70,
          70},{-70,17},{-21,17}}, color={0,0,127}));
  connect(TChiWatSupSet, chiSwi.TSet) annotation (Line(points={{-120,-70},{-70,
          -70},{-70,5},{-21,5}}, color={0,0,127}));
  connect(chiSwi.y, yChi) annotation (Line(points={{1,9.4},{20,9.4},{20,70},{
          120,70}}, color={255,0,255}));
  connect(chiSwi.y, con1.u) annotation (Line(points={{1,9.4},{1,10},{20,10},{20,
          -30},{38,-30}}, color={255,0,255}));
  connect(chiSwi.y, invCon.u) annotation (Line(points={{1,9.4},{2,9.4},{2,10},{
          20,10},{20,-70},{38,-70}}, color={255,0,255}));
