...
partial model EnergyMonitoring "Energy monitoring system"
  ...
  Modelica.Blocks.Sources.RealExpression PIT(y=QRooIntGai_flow)
...
equation
  ...
  connect(PIT.y,EIT. u) annotation (Line(
      ...
      color={0,0,127},
      smooth=Smooth.None));
  connect(PAll.y, samPAll.u) annotation (Line(points={{-537,-94},{-518,-94},{-518,
          -116},{-500,-116}}, color={0,0,127}));
  connect(PCooTowFan1.y, PCooTowAgg.u) annotation (Line(
      points={{-537,-234},{-518,-234},{-518,-226},{-500,-226}},
      color={0,0,127},
      smooth=Smooth.None));
  connect(PCooTowFan1.y, samPCooTow.u) annotation (Line(points={{-537,-234},{-518,
          -234},{-518,-256},{-500,-256}}, color={0,0,127}));
  connect(PChiWatPum1.y, PChiWatPumAgg.u) annotation (Line(
      points={{-437,-96},{-418,-96},{-418,-88},{-400,-88}},
      color={0,0,127},
      smooth=Smooth.None));
  connect(PChiWatPum1.y, samPChiWatPum.u) annotation (Line(points={{-437,-96},{-418,
          -96},{-418,-118},{-400,-118}}, color={0,0,127}));
  connect(PConWatPum1.y, PConWatPumAgg.u) annotation (Line(
      points={{-437,-168},{-418,-168},{-418,-158},{-400,-158}},
      color={0,0,127},
      smooth=Smooth.None));
  connect(PConWatPum1.y, samPConWatPum.u) annotation (Line(points={{-437,-168},{-418,
          -168},{-418,-188},{-400,-188}}, color={0,0,127}));
  connect(PChi1.y, PChiAgg.u) annotation (Line(
      points={{-537,-164},{-518,-164},{-518,-156},{-500,-156}},
      color={0,0,127},
      smooth=Smooth.None));
  connect(PChi1.y, samPChi.u) annotation (Line(points={{-537,-164},{-518,-164},{-518,
          -186},{-500,-186}}, color={0,0,127}));
  connect(PSupFan1.y, PSupFanAgg.u) annotation (Line(
      points={{-437,-238},{-418,-238},{-418,-228},{-400,-228}},
      color={0,0,127},
      smooth=Smooth.None));
  connect(PSupFan1.y, samPSupFan.u) annotation (Line(points={{-437,-238},{-418,-238},
          {-418,-258},{-400,-258}}, color={0,0,127}));
  annotation (
