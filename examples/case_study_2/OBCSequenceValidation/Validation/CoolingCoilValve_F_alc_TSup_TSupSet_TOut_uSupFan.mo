...
model CoolingCoilValve_F_alc_TSup_TSupSet_TOut_uSupFan
...
// Tests controler operation when supply air temperature is within limiter values
  ...
  CoolingCoilValve_F_alc cooVal annotation (Placement(transformation(extent={{-40,80},{-20,100}})));
  CoolingCoilValve_F_alc cooVal1
    annotation (Placement(transformation(extent={{-40,-40},{-20,-20}})));
  CoolingCoilValve_F_alc cooVal2 annotation (Placement(transformation(extent={{140,78},{160,98}})));
  CoolingCoilValve_F_alc cooVal3
  ...
  Buildings.Controls.OBC.CDL.Continuous.Sources.Constant uFanFee(final k=fanFee)
    "Supply fan feedback" annotation (Placement(transformation(extent={{-80,40},{-60,60}})));
  Buildings.Controls.OBC.CDL.Continuous.Sources.Constant uFanFee1(final k=fanFee)
    "Supply fan feedback" annotation (Placement(transformation(extent={{-80,-80},{-60,-60}})));
  Buildings.Controls.OBC.CDL.Continuous.Sources.Constant uFanFee2(final k=fanFee)
    "Supply fan feedback" annotation (Placement(transformation(extent={{100,40},{120,60}})));
  Buildings.Controls.OBC.CDL.Continuous.Sources.Constant uFanFee3(final k=fanFee)
    "Supply fan feedback" annotation (Placement(transformation(extent={{100,-80},{120,-60}})));
equation
  connect(uTSup.y, cooVal.TSup)
    annotation (Line(points={{-139,90},{-90,90},{-90,100},{-41,100}}, color={0,0,127}));
  connect(uTSupSet.y, cooVal.TSupSet) annotation (Line(points={{-139,50},{-130,50},{-130,80},{-84,
          80},{-84,80},{-84,80},{-84,97},{-41,97}}, color={0,0,127}));
  connect(uTOutAboveCutoff.y, cooVal.TOut) annotation (Line(points={{-99,50},{-82,50},{-82,92},{-82,
  ...
  connect(uTSupSet1.y, cooVal1.TSupSet) annotation (Line(points={{-139,-70},{-132,-70},{-132,-32},{
  ...
  connect(uTSupSet3.y, cooVal3.TSupSet) annotation (Line(points={{41,-70},{46,-70},{46,-34},{64,-34},
  ...
  connect(uSupFan3.y, cooVal3.uFanSta) annotation (Line(points={{121,-100},{128,-100},{128,-100},{
...
end CoolingCoilValve_F_alc_TSup_TSupSet_TOut_uSupFan;
