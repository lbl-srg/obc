...
model CoolingCoilValve_F_customPI_withTrends
  ...
  Modelica.Blocks.Sources.CombiTimeTable TOut_F(
    ...
    columns={3},
    fileName=("/home/mg/data/trends/obc_validation_study/LBNL_building_trend_OA_Temp.mos"))
  ...
  Modelica.Blocks.Sources.CombiTimeTable coolingValveSignal(
    ...
    columns={3},
    smoothness=Modelica.Blocks.Types.Smoothness.LinearSegments,
    fileName="/home/mg/data/trends/obc_validation_study/LBNL_building_trend_Clg_Coil_Valve.mos")
  ...
  Modelica.Blocks.Sources.CombiTimeTable fanFeedback(
    ...
    columns={3},
    smoothness=Modelica.Blocks.Types.Smoothness.LinearSegments,
    fileName=("/home/mg/data/trends/obc_validation_study/LBNL_building_trend_VFD_Fan_Feedback.mos"))
    "Fan feedback"
  ...
  Modelica.Blocks.Sources.CombiTimeTable fanStatus(
    ...
    columns={3},
    smoothness=Modelica.Blocks.Types.Smoothness.LinearSegments,
    fileName=("/home/mg/data/trends/obc_validation_study/LBNL_building_trend_VFD_Fan_Enable.mos"))
    "Fan status"
  ...
  Modelica.Blocks.Sources.CombiTimeTable TSupply_F(
    ...
    columns={3},
    fileName=("/home/mg/data/trends/obc_validation_study/LBNL_building_trend_Supply_Air_Temp.mos"))
