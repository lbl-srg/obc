...
model CoolingCoilValve_disIntPI_Trends
  ...
  Modelica.Blocks.Sources.CombiTimeTable TOut_F(
    ...
    columns={3},
    fileName=("/home/mg/repos/obc/examples/validation_example/OBCSequenceValidation/Data/OA_Temp.mos"))
  ...
  Modelica.Blocks.Sources.CombiTimeTable TSupSetpoint_F(
    ...
    columns={3},
    fileName=("/home/mg/repos/obc/examples/validation_example/OBCSequenceValidation/Data/SA_Clg_Stpt.mos"))
  ...
  Modelica.Blocks.Sources.CombiTimeTable coolingValveSignal(
    ...
    columns={3},
    smoothness=Modelica.Blocks.Types.Smoothness.LinearSegments,
    fileName="/home/mg/repos/obc/examples/validation_example/OBCSequenceValidation/Data/Clg_Coil_Valve.mos")
  ...
  Modelica.Blocks.Sources.CombiTimeTable fanFeedback(
    ...
    columns={3},
    smoothness=Modelica.Blocks.Types.Smoothness.LinearSegments,
    fileName=("/home/mg/repos/obc/examples/validation_example/OBCSequenceValidation/Data/VFD_Fan_Feedback.mos"))
    "Fan feedback"
  ...
  Modelica.Blocks.Sources.CombiTimeTable fanStatus(
    ...
    columns={3},
    smoothness=Modelica.Blocks.Types.Smoothness.LinearSegments,
    fileName=("/home/mg/repos/obc/examples/validation_example/OBCSequenceValidation/Data/VFD_Fan_Enable.mos"))
    "Fan status"
  ...
  Modelica.Blocks.Sources.CombiTimeTable TSupply_F(
    ...
    columns={3},
    fileName=("/home/mg/repos/obc/examples/validation_example/OBCSequenceValidation/Data/Supply_Air_Temp.mos"))
