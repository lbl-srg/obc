...
def B33_trend_data_csv2mos(path2csv, outpath):
...
## 5s data, June 18
#filenames = ["33-BL-22 VFD Fan Enable.csv", \
#             "33-BL-22 VFD Fan Feedback.csv", "OA Temp.csv", "33-AHU-02 Supply Air Temp.csv", \
#             "SA Clg Stpt.csv", "33-CC-22 Clg Coil Valve.csv"]
#
#folderpath = "G://My Drive//B33_data//AHU-02_5sec//"
#outpath = "G://My Drive//B33_data//AHU-02_5sec//mos//"
#
#for filename in filenames:
#    print("Initiated: ", filename)
#    path = folderpath + filename
#    print(path)
#    B33_trend_data_csv2mos(path, outpath)
