...
protected
  ...
  SystemModel.BoilerPlant.Submodels.BoilerPlantControls.SetPoints.Subsequences.ProportionalRegulator
    proReg(final TRetSet=TRetSet, final TRetMinAll=TRetMinAll)
