within SystemModel.BoilerPlant.Submodels.BoilerPlantControls.SetPoints.Validation;
block HotWaterSupplyTemperatureReset
  ...
  SystemModel.BoilerPlant.Submodels.BoilerPlantControls.SetPoints.HotWaterSupplyTemperatureReset
    ...
    final resAmoVal=3,
    final maxResVal=7,
    final holTimVal=900) "Scenario testing lack of hot-water requests"
  ...
  SystemModel.BoilerPlant.Submodels.BoilerPlantControls.SetPoints.HotWaterSupplyTemperatureReset
    ...
    final resAmoVal=3,
    final maxResVal=7,
    final holTimVal=900) "Scenario testing increasing number of requests"
  ...
  SystemModel.BoilerPlant.Submodels.BoilerPlantControls.SetPoints.HotWaterSupplyTemperatureReset
    ...
    final resAmoVal=3,
    final maxResVal=7,
    final holTimVal=900) "Scenario testing lack of pumps proven on"
  ...
  SystemModel.BoilerPlant.Submodels.BoilerPlantControls.SetPoints.HotWaterSupplyTemperatureReset
    ...
    final resAmoVal=3,
    final maxResVal=7,
    final holTimVal=900) "Scenario testing effect of stage change process"
