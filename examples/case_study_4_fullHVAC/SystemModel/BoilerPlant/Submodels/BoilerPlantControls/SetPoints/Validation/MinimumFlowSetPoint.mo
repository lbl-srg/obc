...
model MinimumFlowSetPoint "Validation model for MinimumFlowSetPoint sequence"
  ...
  SystemModel.BoilerPlant.Submodels.BoilerPlantControls.SetPoints.MinimumFlowSetPoint
    ...
    bypSetRat=0.1) "Test minimum flow setpoint reset for stage-up process"
  ...
  SystemModel.BoilerPlant.Submodels.BoilerPlantControls.SetPoints.MinimumFlowSetPoint
    ...
    final minFloSet={0.1,0.3},
    final maxFloSet={0.25,0.9},
    bypSetRat=0.1) "Test minimum flow setpoint reset for stage-down process"
...
equation
  ...
  annotation (
    ...
    experiment(
      ...
      Interval=1,
      Tolerance=1e-06),
      __Dymola_Commands(file=".Resources/Scripts/Dymola/BoilerPlant/Submodels/BoilerPlantControls/SetPoints/Validation/MinimumFlowSetPoint.mos"
        "Simulate and plot"),
