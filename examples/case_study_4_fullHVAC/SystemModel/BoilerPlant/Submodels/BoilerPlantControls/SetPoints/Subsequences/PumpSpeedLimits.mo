...
block PumpSpeedLimits
  ...
  Buildings.Controls.OBC.CDL.Continuous.MultiplyByParameter gai3(k=(
        minSecPumSpe - 1)) if not have_varPriPum "Normalize signal"
    annotation (Placement(transformation(extent={{0,-50},{20,-30}})));
  Buildings.Controls.OBC.CDL.Continuous.MultiplyByParameter gai4(k=(
        minSecPumSpe - 1)) if have_varPriPum "Normalize signal"
...
equation
  ...
  connect(addPar.y, yMaxSecPumSpe) annotation (Line(points={{52,-40},{90,-40},{90,
  ...
  connect(lim2.y, gai3.u)
    annotation (Line(points={{-8,-40},{-2,-40}}, color={0,0,127}));
  connect(gai3.y, addPar.u)
    annotation (Line(points={{22,-40},{28,-40}}, color={0,0,127}));
  connect(addPar3.u, gai4.y)
    annotation (Line(points={{58,0},{52,0}}, color={0,0,127}));
  connect(gai1.y, gai4.u)
