within SystemModel.BoilerPlant.Submodels.BoilerPlantControls.SetPoints.Subsequences.Validation;
model PumpSpeedLimits
    "Validation model for PumpSpeedLimits sequence"

  SystemModel.BoilerPlant.Submodels.BoilerPlantControls.SetPoints.Subsequences.PumpSpeedLimits
    pumSpeLim(
    final have_varPriPum=true,
    final nSta=1,
    final minSecPumSpe=0.1,
    final minPriPumSpeSta={0.2}) "Testing scenario with variable primary pumps"
