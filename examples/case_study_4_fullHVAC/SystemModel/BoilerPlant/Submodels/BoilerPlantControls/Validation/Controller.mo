within SystemModel.BoilerPlant.Submodels.BoilerPlantControls.Validation;
model Controller
  ...
  SystemModel.BoilerPlant.Submodels.BoilerPlantControls.Controller controller1(
    ...
    final boiDesFlo={0.0003,0.0003},
    final minPriPumSpeSta={0,0,0},
    final speConTypSec=SystemModel.BoilerPlant.Submodels.BoilerPlantControls.Types.SecondaryPumpSpeedControlTypes.remoteDP)
  ...
  SystemModel.BoilerPlant.Submodels.BoilerPlantControls.Controller controller2(
    final have_priOnl=false,
    final have_secFloSen=true,
    final have_varSecPum=true,
    final nBoi=2,
