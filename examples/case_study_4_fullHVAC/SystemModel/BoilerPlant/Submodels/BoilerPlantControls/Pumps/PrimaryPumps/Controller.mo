within SystemModel.BoilerPlant.Submodels.BoilerPlantControls.Pumps.PrimaryPumps;
block Controller
  ...
  parameter Boolean have_secFloSen = true
    ...
    annotation (Dialog(tab="Pump control parameters",
      ...
      enable=speConTyp == SystemModel.BoilerPlant.Submodels.BoilerPlantControls.Types.PrimaryPumpSpeedControlTypes.flowrate));
  ...
  parameter Boolean have_priSecTemSen = true
    ...
    annotation (Dialog(tab="Pump control parameters",
      ...
      enable=speConTyp == SystemModel.BoilerPlant.Submodels.BoilerPlantControls.Types.PrimaryPumpSpeedControlTypes.temperature));
  ...
  parameter Real maxLocDp(
    ...
    annotation (Dialog(tab="Pump control parameters", group="DP-based speed regulation",
      enable=speConTyp == SystemModel.BoilerPlant.Submodels.BoilerPlantControls.Types.PrimaryPumpSpeedControlTypes.localDP));
  ...
  parameter
    ...
    speConTyp=SystemModel.BoilerPlant.Submodels.BoilerPlantControls.Types.PrimaryPumpSpeedControlTypes.remoteDP
  ...
  SystemModel.BoilerPlant.Submodels.BoilerPlantControls.Pumps.PrimaryPumps.Subsequences.EnableLag_headered
    enaLagHotPum(
    final nPum=nPum,
  ...
  SystemModel.BoilerPlant.Submodels.BoilerPlantControls.Pumps.Generic.Speed_localDp
    pumSpeLocDp(
    final nSen=nSen,
    final nPum=nPum,
...
// protected
  parameter Boolean remDPReg = (speConTyp ==SystemModel.BoilerPlant.Submodels.BoilerPlantControls.Types.PrimaryPumpSpeedControlTypes.remoteDP)
    "Boolean flag for pump speed control with remote differential pressure";

  parameter Boolean locDPReg = (speConTyp ==SystemModel.BoilerPlant.Submodels.BoilerPlantControls.Types.PrimaryPumpSpeedControlTypes.localDP)
    "Boolean flag for pump speed control with local differential pressure";

  parameter Boolean temReg = (speConTyp ==SystemModel.BoilerPlant.Submodels.BoilerPlantControls.Types.PrimaryPumpSpeedControlTypes.temperature)
    "Boolean flag for pump speed control with temperature readings";

  parameter Boolean floReg = (speConTyp ==SystemModel.BoilerPlant.Submodels.BoilerPlantControls.Types.PrimaryPumpSpeedControlTypes.flowrate)
  ...
  SystemModel.BoilerPlant.Submodels.BoilerPlantControls.Pumps.PrimaryPumps.Subsequences.EnableLead_dedicated
    enaDedLeaPum(final offTimThr=offTimThr) if not have_heaPriPum
    "Enable lead pump of dedicated pumps"
    annotation (Placement(transformation(extent={{-200,100},{-180,120}})));

  SystemModel.BoilerPlant.Submodels.BoilerPlantControls.Pumps.PrimaryPumps.Subsequences.EnableLead_headered
    enaHeaLeaPum(final nBoi=nBoi) if have_heaPriPum
    "Enable lead pump of headered pumps"
    annotation (Placement(transformation(extent={{-200,60},{-180,80}})));

  SystemModel.BoilerPlant.Submodels.BoilerPlantControls.Pumps.Generic.Speed_remoteDp
    pumSpeRemDp(
    final nSen=nSen,
    final nPum=nPum,
    final minPumSpe=minPumSpe,
  ...
  SystemModel.BoilerPlant.Submodels.BoilerPlantControls.Pumps.PrimaryPumps.Subsequences.Speed_flow
    pumSpeFlo(
    ...
    have_varPriPum and floReg "Pump speed control using flow sensors"
    annotation (Placement(transformation(extent={{-60,-574},{-40,-554}})));

  SystemModel.BoilerPlant.Submodels.BoilerPlantControls.Pumps.PrimaryPumps.Subsequences.Speed_temperature
    pumSpeTem(
    ...
    final oneReqLimHig=oneReqLimHig) if not have_priOnl and have_varPriPum and
    temReg "Pump speed control using temperature sensors"
 ...
 if have_heaPriPum and (not have_priOnl)
  ...
  SystemModel.BoilerPlant.Submodels.BoilerPlantControls.Pumps.Generic.ChangeStatus
    chaPumSta(final nPum=nPum) if not have_heaPriPum
    "Change lead pump status for dedicated primary pumps"
    annotation (Placement(transformation(extent={{58,100},{80,120}})));

  SystemModel.BoilerPlant.Submodels.BoilerPlantControls.Pumps.Generic.ChangeStatus
    chaPumSta1(final nPum=nPum) if have_heaPriPum
    "Change lead pump status for headered primary pumps"
    annotation (Placement(transformation(extent={{58,66},{80,86}})));

  SystemModel.BoilerPlant.Submodels.BoilerPlantControls.Pumps.Generic.ChangeStatus
    chaPumSta2(final nPum=nPum) if have_priOnl and have_heaPriPum
  ...
  SystemModel.BoilerPlant.Submodels.BoilerPlantControls.Pumps.Generic.ChangeStatus
    chaPumSta3(final nPum=nPum) if have_heaPriPum and (not have_priOnl)
  ...
  SystemModel.BoilerPlant.Submodels.BoilerPlantControls.Pumps.Generic.ChangeStatus
    chaPumSta4(final nPum=nPum) if not have_heaPriPum
  ...
  Buildings.Controls.OBC.CDL.Logical.Sources.Constant con2(k=false) if nPum ==
    1 annotation (Placement(transformation(extent={{-94,10},{-74,30}})));
