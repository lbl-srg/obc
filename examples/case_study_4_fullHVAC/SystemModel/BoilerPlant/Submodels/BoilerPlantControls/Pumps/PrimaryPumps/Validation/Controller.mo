within SystemModel.BoilerPlant.Submodels.BoilerPlantControls.Pumps.PrimaryPumps.Validation;
model Controller
  ...
  SystemModel.BoilerPlant.Submodels.BoilerPlantControls.Pumps.PrimaryPumps.Controller
    ...
    final Ti=10,
    final Td=0.1,
    final speConTyp=SystemModel.BoilerPlant.Submodels.BoilerPlantControls.Types.PrimaryPumpSpeedControlTypes.remoteDP)
  ...
  SystemModel.BoilerPlant.Submodels.BoilerPlantControls.Pumps.PrimaryPumps.Controller
    ...
    final Ti=0.5,
    final Td=0.1,
    final speConTyp=SystemModel.BoilerPlant.Submodels.BoilerPlantControls.Types.PrimaryPumpSpeedControlTypes.localDP)
  ...
  SystemModel.BoilerPlant.Submodels.BoilerPlantControls.Pumps.PrimaryPumps.Controller
    ...
    final Ti=0.5,
    final Td=0.1,
    final speConTyp=SystemModel.BoilerPlant.Submodels.BoilerPlantControls.Types.PrimaryPumpSpeedControlTypes.flowrate)
  ...
  SystemModel.BoilerPlant.Submodels.BoilerPlantControls.Pumps.PrimaryPumps.Controller
    ...
    final Ti=0.5,
    final Td=0.1,
    final speConTyp=SystemModel.BoilerPlant.Submodels.BoilerPlantControls.Types.PrimaryPumpSpeedControlTypes.temperature)
...
annotation (
  ...
  __Dymola_Commands(file="modelica://BuildingsResources/Scripts/Dymola/BoilerPlant/Submodels/BoilerPlantControls/Pumps/PrimaryPumps/Validation/Controller.mos"
    "Simulate and plot"),
