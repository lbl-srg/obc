within SystemModel.BoilerPlant.Submodels.BoilerPlantControls.Pumps.PrimaryPumps.Subsequences.Validation;
...
annotation (
  ...
  __Dymola_Commands(file="modelica://BuildingsResources/Scripts/Dymola/BoilerPlant/Submodels/BoilerPlantControls/Pumps/PrimaryPumps/Subsequences/Validation/EnableLead_headered.mos"
    "Simulate and plot"),
