within SystemModel.BoilerPlant.Submodels.BoilerPlantControls.Pumps.SecondaryPumps.Subsequences.Validation;
...
annotation (
  ...
  __Dymola_Commands(file="modelica://BuildingsResources/Scripts/Dymola/BoilerPlant/Submodels/BoilerPlantControls/Pumps/SecondaryPumps/Subsequences/Validation/EnableLag_flowrate.mos"
    "Simulate and plot"),
