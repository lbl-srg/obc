within SystemModel.BoilerPlant.Submodels.BoilerPlantControls.Pumps.SecondaryPumps.Validation;
model Controller
  ...
  SystemModel.BoilerPlant.Submodels.BoilerPlantControls.Pumps.SecondaryPumps.Controller
    ...
    final Ti=10,
    final Td=0.1,
    final speConTyp=SystemModel.BoilerPlant.Submodels.BoilerPlantControls.Types.SecondaryPumpSpeedControlTypes.remoteDP)
  ...
  SystemModel.BoilerPlant.Submodels.BoilerPlantControls.Pumps.SecondaryPumps.Controller
    ...
    final Ti=0.5,
    final Td=0.1,
    final speConTyp=SystemModel.BoilerPlant.Submodels.BoilerPlantControls.Types.SecondaryPumpSpeedControlTypes.localDP)
...
annotation (
  ...
  __Dymola_Commands(file="./Resources/Scripts/Dymola/BoilerPlant/Submodels/BoilerPlantControls/Pumps/SecondaryPumps/Validation/Controller.mos"
    "Simulate and plot"),
