within SystemModel.BoilerPlant.Submodels.BoilerPlantControls.Pumps.SecondaryPumps;
block Controller
  ...
  parameter
    ...
    speConTyp=SystemModel.BoilerPlant.Submodels.BoilerPlantControls.Types.SecondaryPumpSpeedControlTypes.remoteDP
  ...
  SystemModel.BoilerPlant.Submodels.BoilerPlantControls.Pumps.SecondaryPumps.Subsequences.EnableLag_flowrate
    enaLagHotPum(
    final nPum=nPum,
  ...
  SystemModel.BoilerPlant.Submodels.BoilerPlantControls.Pumps.SecondaryPumps.Subsequences.EnableLag_pumpSpeed
    enaLagSecPum(
    final speLim=speLim,
...
protected
  parameter Boolean remDPReg = (speConTyp ==SystemModel.BoilerPlant.Submodels.BoilerPlantControls.Types.SecondaryPumpSpeedControlTypes.remoteDP)
    "Boolean flag for pump speed control with remote differential pressure";

  parameter Boolean locDPReg = (speConTyp ==SystemModel.BoilerPlant.Submodels.BoilerPlantControls.Types.SecondaryPumpSpeedControlTypes.localDP)
  ...
  SystemModel.BoilerPlant.Submodels.BoilerPlantControls.Pumps.SecondaryPumps.Subsequences.EnableLead
