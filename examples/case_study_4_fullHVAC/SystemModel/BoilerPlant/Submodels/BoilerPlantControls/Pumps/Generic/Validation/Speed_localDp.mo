within SystemModel.BoilerPlant.Submodels.BoilerPlantControls.Pumps.Generic.Validation;
model Speed_localDp
...
annotation (
  ...
  __Dymola_Commands(file="modelica://BuildingsResources/Scripts/Dymola/BoilerPlant/Submodels/BoilerPlantControls/Pumps/Generic/Validation/Speed_localDp.mos"
    "Simulate and plot"),
