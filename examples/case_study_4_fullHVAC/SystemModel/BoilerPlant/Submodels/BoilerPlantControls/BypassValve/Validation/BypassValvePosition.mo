within SystemModel.BoilerPlant.Submodels.BoilerPlantControls.BypassValve.Validation;
block BypassValvePosition
  ...
  SystemModel.BoilerPlant.Submodels.BoilerPlantControls.BypassValve.BypassValvePosition
    ...
    final k=1,
    final Ti=10,
    final Td=10e-6) "Test instance for bypass valve controller"
...
First implementation.
  ...
  Icon(coordinateSystem(preserveAspectRatio=false), graphics={
    ...
    __Dymola_Commands(file=
          "./Resources/Scripts/Dymola/BoilerPlant/Submodels/BoilerPlantControls/BypassValve/Validation/BypassValvePosition.mos"
        "Simulate and plot"),
    experiment(
      StartTime=0,
      StopTime=300,
