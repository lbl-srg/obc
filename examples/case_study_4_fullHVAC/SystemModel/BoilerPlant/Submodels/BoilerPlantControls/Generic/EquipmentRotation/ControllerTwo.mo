within SystemModel.BoilerPlant.Submodels.BoilerPlantControls.Generic.EquipmentRotation;
block ControllerTwo
  ...
  SystemModel.BoilerPlant.Submodels.BoilerPlantControls.Generic.EquipmentRotation.Subsequences.Scheduler
    rotSch(
  ...
  SystemModel.BoilerPlant.Submodels.BoilerPlantControls.Generic.EquipmentRotation.Subsequences.MinimumLeadRuntime
...
protected
  ...
  SystemModel.BoilerPlant.Submodels.BoilerPlantControls.Generic.EquipmentRotation.Subsequences.LeastRuntime
  ...
  SystemModel.BoilerPlant.Submodels.BoilerPlantControls.Generic.EquipmentRotation.Subsequences.ContinuousLeadSwapTwo
    leaSwa if continuous
    "Ensures no old lead device is switched off until the new lead device is proven on"
    annotation (Placement(transformation(extent={{100,20},{120,40}})));

  SystemModel.BoilerPlant.Submodels.BoilerPlantControls.Generic.EquipmentRotation.Subsequences.Two
