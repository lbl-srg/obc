within SystemModel.BoilerPlant.Submodels.BoilerPlantControls.Generic.EquipmentRotation.Validation;
model ControllerTwo
  "Validates lead/lag and lead/standby equipment rotation controller for two devices or groups of devices"

  SystemModel.BoilerPlant.Submodels.BoilerPlantControls.Generic.EquipmentRotation.ControllerTwo
...
equation
  ...
  connect(pre2.y, conLeaSch.uDevSta) annotation (Line(points={{82,-70},{90,-70},
   ...
   experiment(StopTime=100000.0, Tolerance=1e-06),
    __Dymola_Commands(file="./Resources/Scripts/Dymola/Controls/OBC/ASHRAE/PrimarySystem/ChillerPlant/Generic/EquipmentRotation/Validation/ControllerTwo.mos"
    "Simulate and plot"),
