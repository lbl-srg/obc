within SystemModel.BoilerPlant.Submodels.BoilerPlantControls.Generic.Subsequences.Validation;
model HWIsoVal
    "Validate isolation valve disable sequence"

  SystemModel.BoilerPlant.Submodels.BoilerPlantControls.Generic.Subsequences.HWIsoVal
    cloHotIsoVal(final chaHotWatIsoRat=1/60) "Close isolation valve"
    annotation (Placement(transformation(extent={{-100,0},{-80,20}})));

  SystemModel.BoilerPlant.Submodels.BoilerPlantControls.Generic.Subsequences.HWIsoVal
    cloHotIsoVal1(final chaHotWatIsoRat=1/60) "Close isolation valve"
...
annotation (
  ...
  __Dymola_Commands(file="modelica://BuildingsResources/Scripts/Dymola/BoilerPlant/Submodels/BoilerPlantControls/Generic/Subsequences/Validation/HWIsoVal.mos"
    "Simulate and plot"),
