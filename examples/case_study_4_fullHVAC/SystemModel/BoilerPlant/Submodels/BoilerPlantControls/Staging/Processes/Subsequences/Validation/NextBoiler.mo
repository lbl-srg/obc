...
annotation (
 experiment(StopTime=120, Tolerance=1e-06),
  __Dymola_Commands(file="./Resources/Scripts/Dymola/BoilerPlant/Submodels/BoilerPlantControls/Staging/Processes/Subsequences/Validation/NextBoiler.mos"
    "Simulate and plot"),
