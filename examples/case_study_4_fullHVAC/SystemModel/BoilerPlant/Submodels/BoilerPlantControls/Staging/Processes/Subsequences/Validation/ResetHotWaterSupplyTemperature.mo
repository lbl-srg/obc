...
model ResetHotWaterSupplyTemperature
  ...
  SystemModel.BoilerPlant.Submodels.BoilerPlantControls.Staging.Processes.Subsequences.ResetHotWaterSupplyTemperature
    ...
    final sigDif=0.1) "Scenario testing reset for condensing boiler stage type"
...
annotation (
 experiment(
      ...
      Interval=1,
      Tolerance=1e-06),
  __Dymola_Commands(file="modelica:///Resources/Scripts/Dymola/BoilerPlant/Submodels/BoilerPlantControls/Staging/Processes/Subsequences/Validation/ResetHotWaterSupplyTemperature.mos"
    "Simulate and plot"),
