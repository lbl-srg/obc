...
annotation (
 experiment(
      ...
      Interval=1,
      Tolerance=1e-06),
  __Dymola_Commands(file="./Resources/Scripts/Dymola/BoilerPlant/Submodels/BoilerPlantControls/Staging/Processes/Subsequences/Validation/ResetHotWaterSupplyTemperature.mos"
    "Simulate and plot"),
