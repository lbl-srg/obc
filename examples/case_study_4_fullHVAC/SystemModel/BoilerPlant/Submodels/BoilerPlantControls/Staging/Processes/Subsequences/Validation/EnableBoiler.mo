...
annotation (
 experiment(StopTime=3600, Tolerance=1e-06),
  __Dymola_Commands(file="modelica:///Resources/Scripts/Dymola/BoilerPlant/Submodels/BoilerPlantControls/Staging/Processes/Subsequences/Validation/EnableBoiler.mos"
    "Simulate and plot"),
