within SystemModel.BoilerPlant.Submodels.BoilerPlantControls.Staging.Processes.Subsequences.Validation;
model EnableBoiler
    "Validate sequence of enabling and disabling boiler"

  SystemModel.BoilerPlant.Submodels.BoilerPlantControls.Staging.Processes.Subsequences.EnableBoiler
    enaDisBoi(final nBoi=3) "Enable larger boiler and disable smaller boiler"
    annotation (Placement(transformation(extent={{-80,70},{-60,90}})));

  SystemModel.BoilerPlant.Submodels.BoilerPlantControls.Staging.Processes.Subsequences.EnableBoiler
    enaOneBoi(final nBoi=3) "Enable additional boiler"
...
annotation (
 experiment(StopTime=3600, Tolerance=1e-06),
  __Dymola_Commands(file="modelica://BuildingsResources/Scripts/Dymola/BoilerPlant/Submodels/BoilerPlantControls/Staging/Processes/Subsequences/Validation/EnableBoiler.mos"
    "Simulate and plot"),
