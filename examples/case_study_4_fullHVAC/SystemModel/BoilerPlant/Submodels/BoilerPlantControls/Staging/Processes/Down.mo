within SystemModel.BoilerPlant.Submodels.BoilerPlantControls.Staging.Processes;
block Down
...
protected
 ...
 if have_priOnl "Reset process for minimum flow bypass valve setpoint"
  ...
  SystemModel.BoilerPlant.Submodels.BoilerPlantControls.Staging.Processes.Subsequences.NextBoiler
    nexBoi(final nBoi=nBoi)
  ...
  SystemModel.BoilerPlant.Submodels.BoilerPlantControls.Staging.Processes.Subsequences.HWIsoVal
    enaHotWatIsoVal(
    final nBoi=nBoi,
  ...
  SystemModel.BoilerPlant.Submodels.BoilerPlantControls.Staging.Processes.Subsequences.DisableBoiler
    disBoi(final nBoi=nBoi, final proOnTim=boiChaProOnTim)
