...
model Down
  ...
  SystemModel.BoilerPlant.Submodels.BoilerPlantControls.Staging.Processes.Down dowProCon1(
    final have_priOnl=false,
  ...
  SystemModel.BoilerPlant.Submodels.BoilerPlantControls.Staging.Processes.Down dowProCon4(
...
annotation (
 experiment(
      ...
      Interval=1,
      Tolerance=1e-06),
  __Dymola_Commands(file="modelica://BuildingsResources/Scripts/Dymola/BoilerPlant/Submodels/BoilerPlantControls/Staging/Processes/Validation/Down.mos"
    "Simulate and plot"),
