within SystemModel.BoilerPlant.Submodels.BoilerPlantControls.Staging.Processes.Validation;
model Up
  ...
  SystemModel.BoilerPlant.Submodels.BoilerPlantControls.Staging.Processes.Up upProCon1(
    final have_priOnl=false,
    final have_heaPriPum=true,
    final nBoi=nBoi,
    final nSta=nSta,
  ...
  SystemModel.BoilerPlant.Submodels.BoilerPlantControls.Staging.Processes.Up upProCon2(
    final have_priOnl=false,
  ...
  SystemModel.BoilerPlant.Submodels.BoilerPlantControls.Staging.Processes.Up upProCon3(
    final have_priOnl=false,
    final have_heaPriPum=false,
    final nBoi=nBoi,
    final nSta=nSta,
  ...
  SystemModel.BoilerPlant.Submodels.BoilerPlantControls.Staging.Processes.Up upProCon4(
...
annotation (
 experiment(
      ...
      Interval=1,
      Tolerance=1e-06),
  __Dymola_Commands(file="modelica://BuildingsResources/Scripts/Dymola/BoilerPlant/Submodels/BoilerPlantControls/Staging/Processes/Validation/Up.mos"
    "Simulate and plot"),
