...
model DisableBoiler
  ...
  SystemModel.BoilerPlant.Submodels.BoilerPlantControls.Staging.Processes.Subsequences.DisableBoiler
    boiOnOff(final nBoi=3, final proOnTim=300)
    "Disable a boiler and enable another boiler"
    annotation (Placement(transformation(extent={{-80,70},{-60,90}})));

  SystemModel.BoilerPlant.Submodels.BoilerPlantControls.Staging.Processes.Subsequences.DisableBoiler
    boiOff(final nBoi=3, final proOnTim=300) "Disable boiler"
...
annotation (
 experiment(StopTime=3600, Tolerance=1e-06),
  __Dymola_Commands(file="modelica:///Resources/Scripts/Dymola/BoilerPlant/Submodels/BoilerPlantControls/Staging/Processes/Subsequences/Validation/DisableBoiler.mos"
    "Simulate and plot"),
