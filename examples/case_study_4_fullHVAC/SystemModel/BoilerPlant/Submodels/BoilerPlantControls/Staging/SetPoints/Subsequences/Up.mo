...
protected
  SystemModel.BoilerPlant.Submodels.BoilerPlantControls.Staging.SetPoints.Subsequences.EfficiencyCondition
    effCon(
    final nSta=nSta,
    final fraNonConBoi=fraNonConBoi,
    final fraConBoi=fraConBoi,
    final delCapReq=delEffCon,
    final sigDif=sigDif) "Efficiency condition for staging up"
  ...
  SystemModel.BoilerPlant.Submodels.BoilerPlantControls.Staging.SetPoints.Subsequences.FailsafeCondition
    ...
    final TDif=TDif,
    final TDifHys=TDifHys) "Failsafe condition for staging up and down"
