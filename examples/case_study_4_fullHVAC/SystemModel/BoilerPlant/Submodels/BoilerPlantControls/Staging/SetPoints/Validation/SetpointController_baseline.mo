within SystemModel.BoilerPlant.Submodels.BoilerPlantControls.Staging.SetPoints.Validation;
model SetpointController_baseline
  "Validates boiler stage status setpoint signal generation for boiler plants"

  SystemModel.BoilerPlant.Submodels.BoilerPlantControls.Staging.SetPoints.SetpointController_baseline
    staSetCon(
...
annotation (
 experiment(StopTime=14000.0, Tolerance=1e-06),
  __Dymola_Commands(file="modelica://BuildingsResources/Scripts/Dymola/BoilerPlant/Submodels/BoilerPlantControls/Staging/SetPoints/Validation/SetpointController.mos"
    "Simulate and plot"),
