within SystemModel.BoilerPlant.Submodels.BoilerPlantControls.Staging.SetPoints.Subsequences.Validation;
block FailsafeCondition
  "Validation model for FailsafeCondition"

  SystemModel.BoilerPlant.Submodels.BoilerPlantControls.Staging.SetPoints.Subsequences.FailsafeCondition
    faiSafCon(
    final delEna=900,
    final TDif=10,
  ...
  SystemModel.BoilerPlant.Submodels.BoilerPlantControls.Staging.SetPoints.Subsequences.FailsafeCondition
    ...
    final delEna=900,
    final TDif=10,
    final TDifHys=1) "Testing scenario exhibiting lower limit of hysteresis loop in sequence being
    unmet" annotation (Placement(transformation(extent={{-40,-60},{-20,-40}})));

  SystemModel.BoilerPlant.Submodels.BoilerPlantControls.Staging.SetPoints.Subsequences.FailsafeCondition
    faiSafCon3(
    final delEna=900,
    final TDif=10,
    final TDifHys=1) "Testing scenario exhibitng lower limit of hysteresis loop in sequence being
    met" annotation (Placement(transformation(extent={{60,-60},{80,-40}})));

  SystemModel.BoilerPlant.Submodels.BoilerPlantControls.Staging.SetPoints.Subsequences.FailsafeCondition
    faiSafCon4(
    final delEna=900,
    final TDif=10,
    final TDifHys=1) "Testing scenario with timer reset"
