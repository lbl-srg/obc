...
model Status
  ...
  SystemModel.BoilerPlant.Submodels.BoilerPlantControls.Staging.SetPoints.Subsequences.Status
    ...
    final nSta=4,
    final nBoi=3,
    final staMat={{1,0,0},{1,1,0},{0,1,1},{1,1,1}}) "Tests boiler stage status"
...
annotation (
  experiment(StopTime=10.0,
    Tolerance=1e-06),
  __Dymola_Commands(file="modelica://BuildingsResources/Scripts/Dymola/BoilerPlant/Submodels/BoilerPlantControls/Staging/SetPoints/Subsequences/Validation/Status.mos"
    "Simulate and plot"),
