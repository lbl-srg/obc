...
block SetpointController
  ...
  SystemModel.BoilerPlant.Submodels.BoilerPlantControls.Staging.SetPoints.Subsequences.CapacityRequirement
    capReq1(final avePer=avePer) "Capacity requirement calculator"
    annotation (Placement(transformation(extent={{-360,240},{-340,260}})));

  SystemModel.BoilerPlant.Submodels.BoilerPlantControls.Staging.SetPoints.Subsequences.Capacities
    cap(final nSta=nSta)
...
protected
  ...
  SystemModel.BoilerPlant.Submodels.BoilerPlantControls.Staging.SetPoints.Subsequences.Status
    sta(
    final nSta=nSta,
    final nBoi=nBoi,
    final staMat=staMat)
  ...
  SystemModel.BoilerPlant.Submodels.BoilerPlantControls.Staging.SetPoints.Subsequences.Up
    staUp(
    final nSta=nSta,
  ...
  SystemModel.BoilerPlant.Submodels.BoilerPlantControls.Staging.SetPoints.Subsequences.Down
    staDow(
