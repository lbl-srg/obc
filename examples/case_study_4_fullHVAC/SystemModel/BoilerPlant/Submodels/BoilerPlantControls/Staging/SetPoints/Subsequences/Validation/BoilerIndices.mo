...
model BoilerIndices
  ...
  SystemModel.BoilerPlant.Submodels.BoilerPlantControls.Staging.SetPoints.Subsequences.BoilerIndices
    ...
    final nSta=3,
    final nBoi=2,
    final staMat={{1,0},{0,1},{1,1}}) "Boiler index generator"
...
annotation (
 experiment(StopTime=10.0, Tolerance=1e-06),
  __Dymola_Commands(file="./Resources/Scripts/Dymola/BoilerPlant/Submodels/BoilerPlantControls/Staging/SetPoints/Subsequences/Validation/BoilerIndices.mos"
    "Simulate and plot"),
