...
model Up
  ...
  SystemModel.BoilerPlant.Submodels.BoilerPlantControls.Staging.SetPoints.Subsequences.Up
    ...
    final sigDif=0.1,
    final TDif=10,
    final TDifHys=1) "Scenario testing activation by efficiency condition"
  ...
  SystemModel.BoilerPlant.Submodels.BoilerPlantControls.Staging.SetPoints.Subsequences.Up
    ...
    final sigDif=0.1,
    final TDif=10,
    final TDifHys=1) "Scenario testing activation by failsafe condition"
...
annotation (
  experiment(
      ...
      Interval=1,
      Tolerance=1e-06),
  __Dymola_Commands(file="modelica://BuildingsResources/Scripts/Dymola/BoilerPlant/Submodels/BoilerPlantControls/Staging/SetPoints/Subsequences/Validation/Up.mos"
    "Simulate and plot"),
