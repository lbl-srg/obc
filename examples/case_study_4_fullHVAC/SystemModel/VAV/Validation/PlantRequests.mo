...
model PlantRequests
  ...
  SystemModel.VAV.PlantRequests plaReq
    "Calculate plant request"
    annotation (Placement(transformation(extent={{60,50},{80,70}})));
  SystemModel.VAV.PlantRequests plaReq1(
...
annotation (
  ...
  __Dymola_Commands(file="modelica://SystemModel/Resources/Scripts/Dymola/VAV/Validation/PlantRequests.mos"
        "Simulate and plot"),
    Documentation(info="<html>
<p>
This example validates
<a href=\"modelica://SystemModel.VAV.PlantRequests\">
SystemModel.VAV.PlantRequests</a>
